...
public class DeleteQuestionCommandValidatorTests
{
    ...
    {
        // Arrange
        var command = new DeleteQuestionCommand { QuizId = quizId, Id = "test-id" };
    ...
    {
        // Arrange
        var command = new DeleteQuestionCommand { QuizId = "test-quiz", Id = id };
    ...
    {
        // Arrange
        var command = new DeleteQuestionCommand { QuizId = "test-quiz", Id = "test-id" };
